      ...
      <footer className="py-12 px-4 bg-green-800">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-5">
            <a href="#" aria-label="Instagram" className="text-green-100 hover:text-white transition-colors">
            ...
            <a href="#" aria-label="TikTok" className="text-green-100 hover:text-white transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="mailto:hallo@jaeja.is" aria-label="Email" className="text-green-100 hover:text-white transition-colors">
